"""
Django settings for hhnk project.
...
WSGI_APPLICATION = 'hhnk.wsgi.application'
...
GRAPPELLI_ADMIN_TITLE='Beheer van HHNK Meet'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(LOGGING_ROOT, 'hhnk.log'),
            'when': 'D',
